                        ...
                        <Border Background="#f8fafc" CornerRadius="8" Padding="16" Margin="4">
                            <StackPanel>
                                <Viewbox Width="24" Height="24">
                                    <Path Data="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9zM1 9h4v12H1z" 
                                          Fill="#4A5568"/>
                                </Viewbox>
    ...
    $Timer.Add_Tick({
        if ($OULoadJob.State -eq 'Completed') {
            ...
            try {
                ...
                # Only try to remove the job if it exists
                if (Get-Job -Id $OULoadJob.Id -ErrorAction SilentlyContinue) {
                    Remove-Job -Job $OULoadJob -ErrorAction SilentlyContinue
                }
